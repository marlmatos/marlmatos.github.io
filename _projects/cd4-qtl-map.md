---
layout: page
title: Multi-omic QTL map of CD4+ T cells
description: A pan-CD4+ T-cell multi-omic QTL map linking regulatory variants to 46 immune-mediated diseases and traits, integrated with predictive models of variant effects.
img:
importance: 2
category: research
related_publications: matos2026multiomic
github: https://github.com/marlmatos/cd4-qtl-map
---

This project generated a pan-CD4+ T-cell multi-omic map to define regulatory mechanisms underlying immune phenotypes, age-associated variation, and disease-relevant biology, as part of a cohort-scale human genetics study in primary CD4+ T cells.
